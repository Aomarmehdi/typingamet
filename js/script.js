...
function randomPEnd() {
  ...
  return randomIndex === punctuationEndCoust ? punctuationEnd[randomIndex - 1] : punctuationEnd[randomIndex];
}
function randomFiEn() {
...
console.log(`the value of a and b ${a} ${b}`)
  function newGame() {
    ...
    b == false ?localStorage.setItem("b", false): localStorage.setItem("b", true);
  ...
  for (let i = 0; i < 200; i++) {
    ...
    if (b === true)
    document.getElementById("words").innerHTML += formatPunctuation(randomWord())
