...
document.querySelector(".time").addEventListener("click",function me (e)  {
  ...
  newGame()
  document.querySelector(".temps").lastElementChild.innerHTML = e.originalTarget.innerText
...
// console.log(a)
// console.log(time);
console.log(parseInt(document.querySelector(".temps").lastElementChild.textContent))
...
function newGame() {
  ...
  // console.log(document.querySelector(".word").className);
  addClass(document.querySelector(".word"), "current");
  addClass(document.querySelector(".letter"), "current");
  document.querySelector('.temps').lastElementChild.innerHTML = (gameTime / 1000) + ''
  window.timer = null;
}
...
document.addEventListener('keydown', (ev) => {
  ...
  if (!window.timer && isLetter) {
    window.timer = setInterval(() => {
      ...
      document.querySelector('.temps').lastElementChild.innerHTML = sLeft + '';
    }, 1000);
}
  if (isLetter) {
    if (currentLetter) {
...
document.querySelector(".mistake").lastElementChild.innerHTML = `${mistakes}` 
document.querySelector(".cpm").lastElementChild.innerHTML = `${cpm}`
